...
namespace WPFekzam
{
    ...
    public partial class ShopAuto : DbContext
    {
        ...
        public virtual int usp_add_customers1(string fio, string adress, string phone)
        {
            var fioParameter = fio != null ?
                new ObjectParameter("Fio", fio) :
                new ObjectParameter("Fio", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_add_customers1", fioParameter, adressParameter, phoneParameter);
        }
    
        public virtual int usp_add_employee1(string fio, string post, Nullable<System.DateTime> date_start, Nullable<System.DateTime> date_end, Nullable<System.DateTime> birthday, string pasport_data, string phone1, string phone2)
        {
            var fioParameter = fio != null ?
                new ObjectParameter("fio", fio) :
                new ObjectParameter("fio", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_add_employee1", fioParameter, postParameter, date_startParameter, date_endParameter, birthdayParameter, pasport_dataParameter, phone1Parameter, phone2Parameter);
        }
    
        public virtual int usp_add_orders1(string order_details, string order_status, string waybill_num, Nullable<decimal> sum_final, Nullable<decimal> sum_payed, Nullable<System.DateTime> order_date, Nullable<System.DateTime> date_send, Nullable<System.DateTime> date_arrive, string delivery)
        {
            var order_detailsParameter = order_details != null ?
                new ObjectParameter("Order_details", order_details) :
                new ObjectParameter("Order_details", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_add_orders1", order_detailsParameter, order_statusParameter, waybill_numParameter, sum_finalParameter, sum_payedParameter, order_dateParameter, date_sendParameter, date_arriveParameter, deliveryParameter);
        }
    
        public virtual int usp_add_orders_details1(Nullable<int> order_id, Nullable<int> product_id, Nullable<int> quantity)
        {
            var order_idParameter = order_id.HasValue ?
                new ObjectParameter("order_id", order_id) :
                new ObjectParameter("order_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_add_orders_details1", order_idParameter, product_idParameter, quantityParameter);
        }
    
        public virtual int usp_add_products1(string brand, string category, string name, string art, string catalogue_num, string manufacturer, Nullable<decimal> price_first, Nullable<decimal> price_sale, string color, Nullable<int> product_rest)
        {
            var brandParameter = brand != null ?
                new ObjectParameter("brand", brand) :
                new ObjectParameter("brand", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_add_products1", brandParameter, categoryParameter, nameParameter, artParameter, catalogue_numParameter, manufacturerParameter, price_firstParameter, price_saleParameter, colorParameter, product_restParameter);
        }
    
        public virtual ObjectResult<usp_count_product_in_category1_Result> usp_count_product_in_category1(string category)
        {
            var categoryParameter = category != null ?
                new ObjectParameter("category", category) :
                new ObjectParameter("category", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_count_product_in_category1_Result>("usp_count_product_in_category1", categoryParameter);
        }
    
        public virtual int usp_delete_customers1(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_delete_customers1", idParameter);
        }
    
        public virtual int usp_delete_employee1(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_delete_employee1", idParameter);
        }
    
        public virtual int usp_delete_orders1(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_delete_orders1", idParameter);
        }
    
        public virtual int usp_delete_orders_details1(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_delete_orders_details1", idParameter);
        }
    
        public virtual int usp_delete_products1(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_delete_products1", idParameter);
        }
    
        public virtual ObjectResult<usp_show_today_orders1_Result> usp_show_today_orders1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_show_today_orders1_Result>("usp_show_today_orders1");
        }
    
        public virtual int usp_update_customers1(string fio, string adress, string phone, Nullable<int> id)
        {
            var fioParameter = fio != null ?
                new ObjectParameter("Fio", fio) :
                new ObjectParameter("Fio", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_update_customers1", fioParameter, adressParameter, phoneParameter, idParameter);
        }
    
        public virtual int usp_update_employee1(string fio, string post, Nullable<System.DateTime> date_start, Nullable<System.DateTime> date_end, Nullable<System.DateTime> birthday, string pasport_data, string phone1, string phone2, Nullable<int> id)
        {
            var fioParameter = fio != null ?
                new ObjectParameter("fio", fio) :
                new ObjectParameter("fio", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_update_employee1", fioParameter, postParameter, date_startParameter, date_endParameter, birthdayParameter, pasport_dataParameter, phone1Parameter, phone2Parameter, idParameter);
        }
    
        public virtual int usp_update_orders1(string order_details, string order_status, string waybill_num, Nullable<decimal> sum_final, Nullable<decimal> sum_payed, Nullable<System.DateTime> order_date, Nullable<System.DateTime> date_send, Nullable<System.DateTime> date_arrive, string delivery, Nullable<int> id)
        {
            var order_detailsParameter = order_details != null ?
                new ObjectParameter("Order_details", order_details) :
                new ObjectParameter("Order_details", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_update_orders1", order_detailsParameter, order_statusParameter, waybill_numParameter, sum_finalParameter, sum_payedParameter, order_dateParameter, date_sendParameter, date_arriveParameter, deliveryParameter, idParameter);
        }
    
        public virtual int usp_update_orders_details1(Nullable<int> order_id, Nullable<int> product_id, Nullable<int> quantity, Nullable<int> id)
        {
            var order_idParameter = order_id.HasValue ?
                new ObjectParameter("order_id", order_id) :
                new ObjectParameter("order_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_update_orders_details1", order_idParameter, product_idParameter, quantityParameter, idParameter);
        }
    
        public virtual int usp_update_products1(string brand, string category, string name, string art, string catalogue_num, string manufacturer, Nullable<decimal> price_first, Nullable<decimal> price_sale, string color, Nullable<int> product_rest, Nullable<int> id)
        {
            var brandParameter = brand != null ?
                new ObjectParameter("brand", brand) :
                new ObjectParameter("brand", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_update_products1", brandParameter, categoryParameter, nameParameter, artParameter, catalogue_numParameter, manufacturerParameter, price_firstParameter, price_saleParameter, colorParameter, product_restParameter, idParameter);
        }
    }
}
